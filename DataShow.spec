...
a = Analysis(['DataShow.py'],
             ...
             binaries=[],
             datas=[],
             hiddenimports=['pkg_resources.py2_warn','MDSplus._mdsshr', 'MDSplus._version', 'MDSplus.apd', 'MDSplus.compound', 'MDSplus.connection', 'MDSplus.descriptor', 'MDSplus.event', 'MDSplus.magic', 'MDSplus.mdsExceptions', 'MDSplus.mdsarray', 'MDSplus.mdsdata', 'MDSplus.mdsdcl', 'MDSplus.mdsplus_wsgi', 'MDSplus.mdsscalar', 'MDSplus.modpython', 'MDSplus.scope', 'MDSplus.tests', 'MDSplus.tree', 'MDSplus.version', 'MDSplus.widgets', 'MDSplus.wsgi'],
             hookspath=[],
             runtime_hooks=[],
             excludes=[],
