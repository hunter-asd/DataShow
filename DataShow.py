        ...
        if btn.text()=="Stop":
            ...
            for i in range(10):
                self.son=Graph(i*self.cfg["screenWidth"],"DS"+str(i+1),self.cfg["screenWidth"],self.cfg["ScreenHeight"],self.cfg["TickSize"],
                               self.cfg["LineWidth"],self.cfg["LegendSize"],self.cfg["XLeftWidth"],self.cfg["BottomHeight"],self.cfg["LineColor1"],
                               self.cfg["LineColor2"])
